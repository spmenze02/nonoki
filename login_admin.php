            ...
            <div class="col-6 mx-auto">
                <div class="card text-center" style="width: 30rem;">
                    ...
                    <div class="card-body">
                        ...
                        <form action="scripts/user_login.php" method="post" class="signin-form">
                            ...
                            <div class="form-group mb-3" hidden>
                                <label class="label" for="student_number">Password</label>
                                <input value="student_number" name="student_number" id="student_number" type="password" class="form-control text-center"
